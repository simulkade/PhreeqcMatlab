...
if ~fvtool_available()
    error('PhreeqcMatlab:fvtoolMissing', ...
        ['FVTool is required for multi-dimensional transport but was not ' ...
         'found on the path. startup.m provisions it automatically into ' ...
         'external/FVTool when git and network are available; otherwise clone ' ...
         'https://github.com/FiniteVolumeTransportPhenomena/FVTool and run ' ...
         'FVToolStartUp yourself.']);
end
